...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.PayType.setText(item.getTitle());
        holder.BillPrice.setText(item.getContent());
...
//        private TextView tvTitle, tvContent;
        private TextView Time, PayType,BillPrice;
        public MyViewHolder(View itemView) {
            super(itemView);
            Time = (TextView) itemView.findViewById(R.id.Time);
            PayType = (TextView) itemView.findViewById(R.id.PayType);
            BillPrice = (TextView) itemView.findViewById(R.id.BillPrice);
        }
    }
